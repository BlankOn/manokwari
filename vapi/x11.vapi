...
namespace X {
	...
	public class Display {
		...
		[CCode (cname = "XSendEvent")]
               	public void send_client_event (Window w, bool propagate, long event_mask, ref ClientMessageEvent event_send);

		[CCode (cname = "XSendEvent")]
               	public void send_expose_event (Window w, bool propagate, long event_mask, ref ExposeEvent event_send);
	...
	[CCode (cname = "XClientMessageEvent", destroy_function="", copy_function="", has_type_id=false)]
	public struct ClientMessageEvent {
		...
		public int format;
		[CCode (cname="data.l", array_length = false)]
		public long[] data_l;
	}
